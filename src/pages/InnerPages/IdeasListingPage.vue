  ...
  <b-container class="ideas-listing-container">
    <b-row>
      <b-col md="12" class="background-independence">
        ...
        <IdeasListing :postList="postList" :errorMessage="listingErrorMessage" :showAlert="isListingAlertShow" :showSpinner="isListingSpinnerShow" @onDeleteSuccess="onDeleteSuccess" @onDeleteError="onDeleteError" @onDismissed="hideListingErrorAlert" />
      </b-col>
    </b-row>
  </b-container>
</template>
